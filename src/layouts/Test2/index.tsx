...
export default function HomeXR() {
  ...
  const models = useMemo(
    () => [
      ...
      {
        path: "/NTST2/Hanging Picture.glb",
        position: [0, 0, 0],
        rotation: [0, 0, 0],
        scale: [1, 1, 1],
        clickable: false,
